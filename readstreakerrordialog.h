...
#ifndef READSTREAKERRORDIALOG_H
#define READSTREAKERRORDIALOG_H

//base class(es)
#include <QDialog>

namespace Ui {
    class ReadStreakErrorDialog;
}

class ReadStreakErrorDialog : public QDialog
{
    Q_OBJECT

//member functions
public:
    explicit ReadStreakErrorDialog(int lineNumber,
                                   QString line,
                                   QWidget *parent = 0);
    ~ReadStreakErrorDialog();
